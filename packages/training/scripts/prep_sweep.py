...
Example usage:
    ...
    prep_sweep.py generate packages/training/data/sweeps/2026-06-05-dense-history-n/
"""
# TODO: add --out-dir to run_bc_local.py and pass $SWEEP_DIR/runs/
#   so local sweep runs land in the sweep directory, not packages/training/data/runs/.
...
# (run_bc_local.py doesn't print run_dir). Check packages/training/data/runs/
